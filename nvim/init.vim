...
"Rust"
autocmd filetype rust nnoremap <F1> :w <bar> ! %:t:r < a.in <CR>
autocmd filetype rust nnoremap <F2> :w <bar> !rustc % && %:t:r < a.in <CR>
autocmd filetype rust nnoremap <F3> :w <bar> !cargo run <CR>
autocmd filetype rust nnoremap <F4> :w <bar> !cargo build <CR>

"Golang"
autocmd filetype go nnoremap <F1> :w <bar> ! %:t:r < a.in <CR>
autocmd filetype go nnoremap <F2> :w <bar> !go build % <CR>
autocmd filetype go nnoremap <F3> :w <bar> !go run % <CR>

"Add Data Linux"
autocmd filetype cpp,c,rust,go nnoremap data :call AddTemplate(" ~/.templates/template_Data")<CR><CR>
